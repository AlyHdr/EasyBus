...
public class AlarmReceiverGoing extends BroadcastReceiver {
    Context context;
    boolean tracking;
    ...
    {
        if (!tracking && defaultPreferences.getBoolean("preference_switch_morningNotif",true))
        {
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
                    ...
                    .setContentText("Reminding you to start service for going")
